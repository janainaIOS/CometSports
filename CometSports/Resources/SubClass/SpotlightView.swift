...
public class AwesomeSpotlightView: UIView {
    ...
    private static let kTextLabelFont = appFontMedium(20)
    private static let kContinueLabelFont =  appFontBold(14)
    private static let kSkipButtonFont = appFontBold(14)
    ...
    public var spotlightMaskColor = UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 0.8) {// 0.6
        didSet {
    ...
    private func setupContinueLabel() {
        let continueLabelWidth = skipButtonModel.isEnable ? 0.5 * bounds.size.width : bounds.size.width
        let continueLabelHeight: CGFloat = 100.0
        ...
        continueLabel.backgroundColor = continueButtonModel.backgroundColor ?? .black
        addSubview(continueLabel)
    }
    
    private func setupSkipSpotlightButton() {
        let continueLabelWidth = 0.5 * bounds.size.width
        let skipSpotlightButtonWidth = bounds.size.width - continueLabelWidth
        let skipSpotlightButtonHeight: CGFloat = 100.0
