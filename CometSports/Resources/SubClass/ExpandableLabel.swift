...
extension ExpandableLabel {
    private func commonInit() {
        ...
        collapsedAttributedLink =  NSAttributedString().boldText("Show More".localized, size: 14, color: .baseColor)
        expandedAttributedLink = NSAttributedString().boldText("Show Less".localized, size: 14, color: .baseColor)
...
extension NSAttributedString {
    ...
    @discardableResult func boldText(_ text: String, size: CGFloat, color: UIColor) -> NSAttributedString {
        let titleAttributes: [NSAttributedString.Key: Any] = [
            NSAttributedString.Key.font: appFontSemiBold(size),
