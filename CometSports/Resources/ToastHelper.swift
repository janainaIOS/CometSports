...
class Toast: NSObject {
    static func show(message: String, view: UIView) {
        ...
        toastContainer.backgroundColor = UIColor.darkGray.withAlphaComponent(0.8)
        ...
        toastLabel.font = appFontRegular(14)
        ...
        let c3 = NSLayoutConstraint(item: toastContainer, attribute: .bottom, relatedBy: .equal, toItem: view, attribute: .bottom, multiplier: 1, constant: -95)
